...
public class ModelT90 extends ModelVehicle //Same as Filename
{
	...
	public ModelT90() //Same as Filename
	{
		...
		barrelModel[2].addBox(0F, 0F, 0F, 15, 3, 3, 0F); // Box 22
		barrelModel[2].setRotationPoint(40F, -10.5F, -5.5F);

		barrelModel[3].addBox(0F, 0F, 0F, 15, 3, 3, 0F); // Box 23
		barrelModel[3].setRotationPoint(40F, -10.5F, 1.5F);

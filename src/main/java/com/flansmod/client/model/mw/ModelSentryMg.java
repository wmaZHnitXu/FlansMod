...
public class ModelSentryMg extends ModelAAGun //Same as Filename
{
	...
	public ModelSentryMg() //Same as Filename
	{
		...
		baseModel[5].setRotationPoint(5F, 4.1F, -5F);
		...
		baseModel[6].setRotationPoint(-5F, 4.1F, 5F);
		...
		baseModel[7].setRotationPoint(5F, 4.1F, 5F);
		...
		seatModel[0].setRotationPoint(-16F, -4F, -8.5F);

		seatModel[1].addBox(0F, 0F, 0F, 26, 6, 17, 0F); // Box 13
		seatModel[1].setRotationPoint(-19F, -10F, -8.5F);
		...
		seatModel[2].setRotationPoint(10F, -10F, -8.5F);
		seatModel[2].rotateAngleX = 3.14159265F;

		seatModel[3].addBox(0F, 0F, 0F, 22, 11, 17, 0F); // Box 15
		seatModel[3].setRotationPoint(-28F, -21F, -8.5F);
		...
		seatModel[4].setRotationPoint(10F, -10F, 8.5F);
		...
		seatModel[5].setRotationPoint(10F, -10F, -5.5F);
		...
		seatModel[6].setRotationPoint(10F, -10F, 1.5F);
		...
		seatModel[10].setRotationPoint(1F, -16F, -8.5F);
		...
		seatModel[11].setRotationPoint(-13F, -5F, -8.5F);
		...
		gunModel[0].addBox(-7F, -16F, 2.5F, 47, 2, 2, 0F); // Box 20
		gunModel[0].setRotationPoint(0F, 0F, 0F);

		gunModel[1].addBox(-7F, -16F, -4.5F, 47, 2, 2, 0F); // Box 21
		gunModel[1].setRotationPoint(0F, 0F, 0F);

		gunModel[2].addBox(40F, -16.5F, -5F, 15, 3, 3, 0F); // Box 22
		gunModel[2].setRotationPoint(0F, 0F, 0F);

		gunModel[3].addBox(40F, -16.5F, 2F, 15, 3, 3, 0F); // Box 23
